...
/**
 * A class that allows YCSB to interact with Spark using Delta Lake tables
 * This class extends {@link DB} and implements the database interface used by
 * YCSB client.
 */
public class SparkDeltaClient extends DB {
  ...
  public void init() throws DBException {
    ...
    lakehouse = props.getProperty(LAKEHOUSE_FORMAT, "delta");
